...
export default function Pillars() {
    ...
    const pillars = [
        { title: 'Body & Rejuvenation', phara: 'Return to ease within the body' },
        { title: 'Mind & Emotions', phara: 'Soften, understand, and clear within' },
        { title: 'Energy & Prana', phara: 'Restore flow and inner vitality' },
        { title: 'Soul & Spirit', phara: 'Reconnect with meaning and stillness' },
        { title: 'Social Connection & Community', phara: 'Feel held, seen, and belong' },
    ];
        ...
        <>
            <section className="bg-white">
                <div className="text-center px-3 pt-18">
                    ...
                    <h1 className="text-title-xl mx-auto text-[#68320A]">A Trailblazer in Integrative Wellness</h1>
                    <p className="text-[#3A391B] font-medium font-montserrat md:text-lg mx-auto max-w-[480px]">We are reimagining wellbeing— not as something to chase, but something to return to.</p>
                </div>
                    ...
                    <div className="w-full md:w-1/2 p-5 sm:p-8 lg:p-18 font-albert">
                        ...
                        <div className="space-y-4">
                            ...
                            {pillars.map((pillar, index) => (
                                <div key={index} className="flex items-start gap-3 text-[#3A391B]">
                                    <img src="" alt="" />
                                    <div className="space-y-1.5">
                                        <h1 className="text-xl">{pillar.title}</h1>
                                        <p className="font-montserrat font-medium">{pillar.phara}</p>
                                    </div>
                                </div>
                            ))}
            ...
            <section className="bg-[#e9e2d3]">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 p-5 sm:p-8 lg:p-18 font-albert">
                        ...
                        <p className="text-[#1F1D1D] font-montserrat font-medium">Discover what’s unfolding— fresh experiences, new pathways, and evolving journeys.</p>
