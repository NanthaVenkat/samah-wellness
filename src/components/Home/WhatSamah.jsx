...
import yogaGroup from '/src/assets/images/home-1.png'
        ...
        <section className="bg-white">
            <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/2 min-h-[460px] overflow-hidden relative group">
                    <div className="parallax absolute -top-[10%] left-0 w-full h-[120%] bg-center bg-cover transition-transform duration-700 ease-out group-hover:scale-105" style={{backgroundImage: `url(${yogaGroup})`}}></div>
                </div>
                ...
                <div className="w-full md:w-1/2 max-w-3xl mx-auto p-5 sm:p-8 lg:p-18 font-albert space-y-2">
                    ...
                    <div className="space-y-4">
                        ...
                        <BubbleButton to='#' btnType='link' className='flex items-center justify-center font-montserrat font-medium py-2 px-4 gap-3 text-white bg-[#68320A] w-full text-center rounded'>
