        ...
        <section className="py-10 bg-[#3A391B]">
            <div class="container mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mt-12">
                    <div class="rounded-xl p-4 flex items-center justify-between gap-5 font-montserrat bg-[#D5CFBA]">
                        <div className="text-[clamp(0.85rem,0.98rem+0.2vw,1.125rem)] text-[#3A391B]">
                            <p className="font-medium">Not just <br /><b>another Studio</b></p>
                        </div>
                        <img src={whatSamah1} alt="" className="object-center object-cover w-[120px] h-[120px] rounded-xl" />
                    </div>
                ...
                <div class="rounded-xl p-7 grid grid-cols-1 lg:grid-cols-[60%_40%] mt-5 bg-[#D5CFBA]">
                    ...
                    <div className="bg-[url('assets/images/holistic.webp')] bg-cover bg-center min-h-[220px] rounded-xl"></div>
                </div>
            </div>
        </section>
    );
